export const SQL_QUERIES = {
  ...
  CREATE_GAME_END: 'INSERT INTO game_end (id, user_id, loc_x, loc_y, score) VALUES (?,?,?,?,?)',
  UPDATE_GAME_END:
    'UPDATE game_end SET loc_x = ?, loc_y = ?, score = ?, end_time = CURRENT_TIMESTAMP WHERE user_id = ?',
};
